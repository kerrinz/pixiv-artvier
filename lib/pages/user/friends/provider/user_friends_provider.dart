...
class UserFriendsNotifier extends BaseAutoDisposeAsyncNotifier<List<CommonUserPreviews>> {
  UserFriendsNotifier({required this.userId});
  ...
  Future<List<CommonUserPreviews>> fetch() async {
    var result = await ApiUser(requester).userFriends(userId, cancelToken: _cancelToken);
