...
Profile _$ProfileFromJson(Map<String, dynamic> json) => Profile(
      ...
      (json['birth_year'] as num).toInt(),
      json['region'] as String,
      (json['address_id'] as num).toInt(),
      json['country_code'] as String,
      json['job'] as String,
      (json['job_id'] as num).toInt(),
      (json['total_follow_users'] as num).toInt(),
      (json['total_mypixiv_users'] as num).toInt(),
      (json['total_illusts'] as num).toInt(),
      (json['total_manga'] as num).toInt(),
      (json['total_novels'] as num).toInt(),
      (json['total_illust_bookmarks_public'] as num).toInt(),
      (json['total_illust_series'] as num).toInt(),
      (json['total_novel_series'] as num).toInt(),
