...
class Illusts extends Object {
  ...
  Illusts(this.id,this.title,this.type,this.imageUrls,this.caption,this.restrict,this.user,this.tags,this.tools,this.createDate,this.pageCount,this.width,this.height,this.sanityLevel,this.xRestrict,this.metaSinglePage,this.metaPages,this.totalView,this.totalBookmarks,this.isBookmarked,this.visible,this.isMuted,this.totalComments,);

  factory Illusts.fromJson(Map<String, dynamic> srcJson) => _$IllustsFromJson(srcJson);
